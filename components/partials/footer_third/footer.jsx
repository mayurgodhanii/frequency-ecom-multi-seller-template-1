...
function Footer_third({ footerContent, logo }) {
...
export default React.memo(Footer_third);
...
//     return (
//       footerContent?.find((item) => item.component.name === name)?.component
//         .components || []
//     );
//   };
...
//                 ))}
//                 {descriptionComponent.map((item, index) => (
//                   <p key={index}>{item.options.text}</p>
//                 ))}
...
//                           )}
//                           {item.name === "phone" && (
//                             <ALink href={`tel:${item.options.text}`}>
//                               {item.options.text}
//                             </ALink>
//                           )}
//                         </React.Fragment>
...
//         <div className={containerClass}>
//           {copyrightComponent.map((item, index) => (
//             <p key={index} className="footer-copyright">
//               {item.options.text}
//             </p>
//           ))}
